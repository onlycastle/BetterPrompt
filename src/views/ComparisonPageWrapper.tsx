 ...
 * Adapts ComparisonPage for Next.js App Router by accepting reportId as a prop
 */
...
interface ComparisonPageWrapperProps {
  reportId?: string;
}

export function ComparisonPageWrapper({ reportId }: ComparisonPageWrapperProps) {
