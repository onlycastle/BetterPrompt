...
/**
 * Credibility tier for influencers
 */
...
export const DEFAULT_INFLUENCERS: Omit<Influencer, 'id' | 'addedAt'>[] = [
  ...
  },
  {
    ...
    credibilityTier: 'medium',
    identifiers: [
      { platform: 'twitter', handle: 'goodside' },
    ],
  ...
  {
    name: 'Addy Osmani',
    description: 'Google Chrome engineering lead, distinguished between vibe coding and AI-assisted engineering',
    credibilityTier: 'high',
    identifiers: [
    ...
    expertiseTopics: ['AI-assisted-engineering', 'vibe-coding-critique', 'web-development', 'developer-productivity'],
    affiliation: 'Google',
    contentCount: 0,
    isActive: true,
  },
