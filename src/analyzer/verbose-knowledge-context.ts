...
import { INITIAL_INSIGHTS, type ProfessionalInsight } from '../domain/models/knowledge.js';
import { DIMENSION_KEYWORDS, type DimensionMapping } from './dimension-keywords.js';
