...
import type { DimensionName, DimensionLevel } from '../models/unified-report.js';
import type { LinkedInsight } from './knowledge-linker.js';
import type { ExtractedQuote } from './dimension-quote-extractor.js';
