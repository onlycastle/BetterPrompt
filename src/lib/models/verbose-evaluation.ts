...
// ============================================================================
// PROJECT SUMMARY - LLM-generated 2-3 line summaries per project
// ============================================================================

/**
 * Summary of a developer's work within a single project.
 * Generated by ProjectSummarizer stage — groups session summaries by project
 * and produces 2-3 meaningful English summary lines.
 */
export const ProjectSummarySchema = z.object({
  projectName: z.string().describe('Project name (last segment of project path)'),
  summaryLines: z.array(z.string()).describe('2-3 English summary lines describing work in this project'),
  sessionCount: z.number().describe('Number of sessions in this project'),
});
