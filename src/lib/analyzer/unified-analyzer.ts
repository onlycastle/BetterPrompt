...
import type { ParsedSession, TypeResult } from '../models/index';
import type {
  UnifiedReport,
  DimensionResult,
  DimensionName,
...
import { calculateAllDimensions, type FullAnalysisResult } from './dimensions/index';
import {
  aggregateMetrics,
  calculateTypeScores,
