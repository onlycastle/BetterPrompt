 ...
 *
 * Mirror of packages/plugin/lib/scanner/path-encoding.ts for the self-hosted Next.js
 * server package. Plugin and server build independently, so this is a separate file.
 *
 * @see packages/plugin/lib/scanner/path-encoding.ts for full documentation
