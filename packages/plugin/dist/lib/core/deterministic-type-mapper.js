...
// ============================================================================
const STYLE_TYPES = ['architect', 'analyst', 'conductor', 'speedrunner', 'trendsetter'];
function computeAffinities(scores, metrics, trendDensity) {
    ...
    const analystAffinity = scores.thinkingQuality * 0.3 +
    ...
    const speedrunnerAffinity = scores.contextEfficiency * 0.5 +
        concisenessScore +
 ...
 */
export function computeDeterministicType(scores, phase1Output) {
...
//# sourceMappingURL=deterministic-type-mapper.js.map