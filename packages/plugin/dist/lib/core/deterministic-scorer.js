...
function scoreThinkingQuality(metrics) {
    ...
    return clampScore(planningScore * 0.4 +
...
function scoreLearningBehavior(metrics) {
    ...
    return clampScore(learningIntentScore * 0.5 +
        mistakeScore * 0.3 +
...
function scoreCommunicationPatterns(metrics, phase1Output) {
    ...
    return clampScore(promptQualityScore * 0.4 +
        structureScore * 0.3 +
...
function scoreControl(metrics) {
    ...
    return clampScore(rejectionSignal * 0.25 +
        questionSignal * 0.25 +
        lengthSignal * 0.25 +
        commandSignal * 0.25);
}
 ...
 */
export function computeDeterministicScores(phase1Output) {
