 ...
 */
export declare abstract class BaseSessionSource implements SessionSource {
    ...
    abstract extractMetadata(filePath: string, content: string): Promise<SourcedSessionMetadata | null>;
    abstract parseSessionContent(sessionId: string, projectPath: string, projectName: string, content: string): Promise<SourcedParsedSession | null>;
