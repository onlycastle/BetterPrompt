...
import { clearAnalysisPending, markAnalysisFailed, markAnalysisStarted, } from '../../lib/debounce.js';
export const definition = {
    name: 'extract_data',
    description: 'Run deterministic Phase 1 data extraction on scanned sessions. ' +
...
export async function execute(args) {
    ...
    try {
        ...
        return JSON.stringify({
            ...
            message: `Extracted ${metrics.totalDeveloperUtterances} utterances from ${metrics.totalSessions} sessions. ` +
