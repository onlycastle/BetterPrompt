...
export const definition = {
    ...
    description: 'Get the developer\'s top growth areas — specific areas where they can improve ' +
    ...
    inputSchema: {
        ...
        properties: {
            domain: {
                type: 'string',
                description: 'Filter by domain key. One of: thinkingQuality, communicationPatterns, ' +
...
//# sourceMappingURL=get-growth-areas.js.map