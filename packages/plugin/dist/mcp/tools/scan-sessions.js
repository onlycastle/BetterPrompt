 ...
 */
import { listAllSessions, cacheParsedSessions, } from '../../lib/core/session-scanner.js';
export const definition = {
    name: 'scan_sessions',
    description: 'Scan Claude Code session logs in ~/.claude/projects/. Returns session metadata ' +
