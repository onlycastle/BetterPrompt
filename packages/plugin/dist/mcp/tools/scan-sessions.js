 ...
 */
import { scanAndCacheParsedSessions, } from '../../lib/core/multi-source-session-scanner.js';
import { getAnalysisLifecycleState, isAnalysisPending } from '../../lib/debounce.js';
export const definition = {
    name: 'scan_sessions',
    description: 'Scan Claude Code and Cursor session logs on this machine. Returns session metadata ' +
...
//# sourceMappingURL=scan-sessions.js.map